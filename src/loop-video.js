...
function setupLoopControls() {
  if (dom.loopCount && dom.loopValue) {
    dom.loopCount.addEventListener('input', (e) => {
      dom.loopValue.textContent = e.target.value;
    });
  }
}
...
function setupExport() {
  dom.btnExport.addEventListener('click', processLoop);
}
